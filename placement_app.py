...
menu = st.sidebar.radio("Go to", ["🏠 Home", "🔍 Filters", "📊 Visualisation"])
...
# --- VISUALISATION PAGE ---
    ...
    # 1. Bar Chart – Placement count by batch
    ...
    # 2. Scatter Plot – Communication Skill vs Placement Package
